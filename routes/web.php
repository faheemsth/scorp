...
//company permission routs
Route::get('/company-permission', [CompanyPermissionController::class, 'index'])->name('company-permission')->middleware(['XSS', 'revalidate',]);
...
// Import Files
Route::get('/import-files', [ImportFilesController::class, 'index'])->name('import_files.index')->middleware(['auth', 'XSS']);
Route::post('/show-file-data', [ImportFilesController::class, 'showFileData'])->name('import_files.show-data')->middleware(['auth', 'XSS']);
Route::post('/syncing-file-data', [ImportFilesController::class, 'syncFileData'])->name('import_files.sync-data')->middleware(['auth', 'XSS']);
Route::post('/syncing-universities', [ImportFilesController::class, 'syncUniversities'])->name('import_files.sync-universities')->middleware(['auth', 'XSS']);


Route::post('/import-leads-file', [ImportFilesController::class, 'importLeads'])->name('import_files.leads')->middleware(['auth', 'XSS']);
Route::get('/convert-lead', [ImportFilesController::class, 'convertLead'])->name('import_files.conver-deal')->middleware(['auth', 'XSS']);
Route::post('/convert-lead-to-deal', [ImportFilesController::class, 'ConverLeadToDeal'])->name('convert.convert-to-deal')->middleware(['auth', 'XSS']);
...
Route::get('/deals/{id}/courses', [DealController::class, 'courseEdit'])->name('deals.courses.edit')->middleware(['auth', 'XSS']);
Route::put('/deals/{id}/courses', [DealController::class, 'courseUpdate'])->name('deals.courses.update')->middleware(['auth', 'XSS']);
Route::delete('/deals/{id}/courses/{uid}', [DealController::class, 'courseDestroy'])->name('deals.courses.destroy')->middleware(['auth', 'XSS']);
...
Route::get('leads/{id}/update-data', [LeadController::class, 'updateLeadData'])->name('leads.update.data')->middleware(['auth', 'XSS']);;
Route::get('deals/{id}/update-data', [DealController::class, 'updateDealData'])->name('deals.update.data')->middleware(['auth', 'XSS']);;
Route::get('deals/{id}/saved-data-field', [DealController::class, 'savedDataField'])->name('deals.saved.data.field');


Route::post('/leads/update/{id}', 'LeadController@update');
Route::post('/deals/update/{id}', 'DealController@update');

Route::get('/leads/get-address/{id}', 'LeadController@FetchAddress');
Route::get('/leads/save-address/{id}', 'LeadController@saveAddress');
Route::get('/leads/get-field/{id}', 'LeadController@fetchLeadField');
...
Route::resource('courseduration', CoursedurationController::class);
Route::resource('courselevel', CourselevelController::class);
...
Route::get('/leads/{id}/courses', [LeadController::class, 'courseEdit'])->name('leads.courses.edit')->middleware(['auth', 'XSS']);
Route::put('/leads/{id}/courses', [LeadController::class, 'courseUpdate'])->name('leads.courses.update')->middleware(['auth', 'XSS']);
Route::delete('/leads/{id}/courses/{uid}', [LeadController::class, 'courseDestroy'])->name('leads.courses.destroy')->middleware(['auth', 'XSS']);
...
Route::post('/deals/{id}/notes', [DealController::class, 'notesStore'])->name('deals.notes.store')->middleware(['auth', 'XSS']);
...
Route::get('/leads/{id}/drive-link', [LeadController::class, 'driveCreate'])->name('leads.drive.create')->middleware(['auth', 'XSS']);
Route::post('/leads/{id}/drive-link', [LeadController::class, 'driveStore'])->name('leads.drive.store')->middleware(['auth', 'XSS']);
Route::get('/leads/{id}/drive-link-delete', [LeadController::class, 'driveDelete'])->name('leads.drive.delete')->middleware(['auth', 'XSS']);
...
Route::post('/deals/getDiscussions', [DealController::class, 'getDiscussions'])->name('deals.getDiscussions')->middleware(['auth', 'XSS']);
Route::post('/deals/saveDiscussions', [DealController::class, 'saveDiscussions'])->name('deals.saveDiscussions')->middleware(['auth', 'XSS']);
Route::post('/deals/getCourses', [DealController::class, 'getCourses'])->name('deals.getCourses')->middleware(['auth', 'XSS']);
Route::post('/leads/getCourses', [LeadController::class, 'getCourses'])->name('leads.getCourses')->middleware(['auth', 'XSS']);

Route::get('/leads/{id}/update-convert', [LeadController::class, 'showUpdatedConvertToDeal'])->name('leads.updated.convert.deal')->middleware(['auth', 'XSS']);
Route::post('/leads/{id}/update-convert-lead', [LeadController::class, 'UpdatedConvertToDeal'])->name('leads.updated.convert.deal')->middleware(['auth', 'XSS']);



Route::post('/leads/import-csv', [LeadController::class, 'importCsv'])->name('leads.importCsv')->middleware(['auth', 'XSS']);
Route::post('/leads/fetch-columns', [LeadController::class, 'fetchColumns'])->name('leads.fetchColumns')->middleware(['auth', 'XSS']);
Route::post('/leads/filter-header', [LeadController::class, 'filterHeader'])->name('leads.filterHeader')->middleware(['auth', 'XSS']);
...
Route::post('/leads/getDiscussions', [LeadController::class, 'getDiscussions'])->name('leads.getDiscussions')->middleware(['auth', 'XSS']);
Route::post('/leads/saveDiscussions', [LeadController::class, 'saveDiscussions'])->name('leads.saveDiscussions')->middleware(['auth', 'XSS']);
Route::resource('leads', LeadController::class)->middleware(['auth', 'XSS']);
Route::get('/update-lead-stage', [LeadController::class, 'updateLeadStage'])->name('update-lead-stage')->middleware(['auth', 'XSS']);


Route::get('/update-deal-stage', [DealController::class, 'updateDealStage'])->name('update-deal-stage')->middleware(['auth', 'XSS']);
...
// Route::get('/leads/{id}/drive-link', [LeadController::class, 'driveCreate'])->name('leads.drive.create')->middleware(['auth','XSS']);
// Route::post('/leads/{id}/drive-link', [LeadController::class, 'driveStore'])->name('leads.drive.store')->middleware(['auth','XSS']);
// Route::get('/leads/{id}/drive-link-delete', [LeadController::class, 'driveDelete'])->name('leads.drive.delete')->middleware(['auth','XS
...
Route::post('/organization/{id}/notes', [OrganizationController::class, 'notesStore'])->name('organization.notes.store')->middleware(['auth', 'XSS']);
Route::get('/organization/{id}/notes-edit', [OrganizationController::class, 'notesEdit'])->name('organization.notes.edit')->middleware(['auth', 'XSS']);
...
Route::get('/tasks/get-field/{id}', 'DealController@fetchOrgField')->middleware(['auth', 'XSS']);
...
Route::get('/organization/edit-tags/{id}', 'OrganizationController@editTags')->name('organization-edit-tags')->middleware(['auth', 'XSS']);
Route::get('organization/{id}/update-data', [OrganizationController::class, 'updateOrgData'])->name('organization.update.data')->middleware(['auth', 'XSS']);;


Route::get('/organization/{id}/discussions', [OrganizationController::class, 'discussionCreate'])->name('organization.discussions.create')->middleware(['auth', 'XSS']);
Route::post('/organization/{id}/discussions', [OrganizationController::class, 'discussionStore'])->name('organization.discussion.store')->middleware(['auth', 'XSS']);
...
Route::get('export/download-sample', [EmployeeController::class, 'downloadSample'])->name('employee.download.sample');
Route::get('import/employee/file', [EmployeeController::class, 'importFile'])->name('employee.file.import');
Route::post('import/empoyee', [EmployeeController::class, 'import'])->name('employee.import');
...
Route::post('deal-settings', [SystemController::class, 'DealSettingStore'])->name('deal.setting.store')->middleware(['auth', 'XSS']);
...
// Deal Application
Route::get('deals/{id}/create-application', [DealController::class, 'createApplication'])->name('deals.application.create');
Route::post('deals/{id}/store-application', [DealController::class, 'storeApplication'])->name('deals.application.store');
...
Route::get('/get-deal-detail', [DealController::class, 'getDealDetails'])->name('get-deal-detail');
Route::get('deals/{id}/detail-application', [DealController::class, 'detailApplication'])->name('deals.application.detail');
Route::get('clients/{id}/client_detail', [ClientController::class, 'clientDetail'])->name('client-detail')->middleware(['auth', 'XSS']);
Route::get('users/{id}/user_detail', [UserController::class, 'userDetail'])->name('user-detail')->middleware(['auth', 'XSS']);
...
//creating Task
Route::get('/organiation/{id}/task', [OrganizationController::class, 'taskCreate'])->name('organiation.tasks.create')->middleware(['auth', 'XSS']);
Route::post('/organization/{id}/task', [OrganizationController::class, 'taskStore'])->name('organization.tasks.store')->middleware(['auth', 'XSS']);
Route::get('/organiation/{id}/task-edit', [OrganizationController::class, 'taskEdit'])->name('organiation.tasks.edit')->middleware(['auth', 'XSS']);
...
>>>>>>> 32f391c1325004d3c76e3fb3619e5d138c585986
