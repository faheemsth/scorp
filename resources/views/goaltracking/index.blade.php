            ...
            <div class="card-body table-border-style">
                <div class="row align-items-center ps-0 ms-0 pe-4 my-2">
                    <div class="col-4 d-flex mb-3">
                        <span>
                            <p class="mb-0 pb-0 ps-1">Goal Tracking</p>
                            <div class="dropdown">
                    ...
                    <div class="col-8 d-flex justify-content-end gap-2 pe-0 mb-3">
                        ...
                        @can('create goal tracking')
                            <a href="#" data-size="lg" data-url="{{ route('goaltracking.create') }}"
                                data-ajax-popup="true" data-bs-toggle="tooltip" title="{{__('Create')}}" style="color:white; width:36px; height: 36px; margin-top:10px;"
                                data-title="{{__('Create New Goal Tracking')}}" class="btn px-2 btn-dark">
                ...
                @include('goaltracking.list_filter')
                            ...
                            @foreach ($goalTrackings as $goalTracking)
                                ...
                                <tr>
                                    <td>
                                        ...
                                        onclick="openSidebar('/GoalTrackingShow?id=<?= $goalTracking->id ?>')"
                                        data-lead-id="{{ $goalTracking->id }}">
                                        {{ !empty($goalTracking->goalType)?$goalTracking->goalType->name:'' }}
                                    </td>
                                    <td>{{$goalTracking->subject}}</td>
                                    <td>{{ $goalTracking->brand }}</td>
                                    <td>{{ $goalTracking->region }}</td>
                                    <td>{{ $goalTracking->branch }}</td>
