...
@section('page-title')
    {{ __('Application Analysis') }}
@endsection
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ route('crm.dashboard') }}">{{ __('Dashboard') }}</a></li>
    <li class="breadcrumb-item">{{ __('Application Analysis') }}</li>
@endsection
        ...
        <div class="col-xl-12">
            ...
            <div class="container">
                <div class="row justify-content-center align-items-center my-4">
                    ...
                    <a class="col-3 py-5 text-decoration-none" href="{{ url('ChartApplication') }}" style="background-color: #B3CDE1; border-radius: 5%;">
                        <div class="row justify-content-center align-items-center">
                            <div class="col-auto d-flex flex-column gap-2 justify-content-center align-items-center">
                                <div style="border: 2px solid black; border-radius: 50%;text-align: center;width: 25px;height: 25px;"
                                    class="p-1 mb-1">
                    ...
                    <div class="card mt-3">
                        <div class="card-body table-border-style" style="padding: 25px 3px;">
                            <div class="row align-items-center justify-content-center ps-0 ms-0 pe-4 my-2">
                                <div class="col-12">
                                    <canvas id="ApplicationByCountry" style="width:100%;max-width:600px"></canvas>
                ...
                <div class="col-6">
                    <div class="card mt-3">
                        <div class="card-body table-border-style" style="padding: 25px 3px;">
                            <div class="row align-items-center justify-content-center ps-0 ms-0 pe-4 my-2">
                                <div class="col-12">
                                    <canvas id="ApplicationByUniversty" style="width:100%;max-width:600px"></canvas>
...
@push('script-page')
    <script>
        ...
        const myChart = new Chart("ApplicationByCountry", chartConfig);
        $.ajax({
            url: '/ApplicationByCountry',
            type: 'GET',
            dataType: 'json',
    ...
    <script>
        ...
        const myDynamicChart = new Chart("ApplicationByUniversty", chartConfigDynamic);
        $.ajax({
            url: '/ApplicationByUniversty',
            type: 'GET',
            dataType: 'json',
            success: function(data) {
