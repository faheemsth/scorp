            ...
            <div class="lead-topbar d-flex flex-wrape justify-content-between align-items-center p-2">
                <div class="d-flex align-items-center">
                    ...
                    <div class="lead-basic-info">
                        <p class="pb-0 mb-0 fw-normal">{{ __('Email Marketing') }}</p>
                ...
                <div class="d-flex justify-content-end gap-1 me-3">
                    ...
                    <a href="#!" data-size="lg" data-url="{{ url('email/marketing/update?id=').$emailMarketing->id }}" data-ajax-popup="true" class="btn px-2 py-2 btn-dark text-white" data-bs-original-title="{{__('Edit Email')}}" data-bs-toggle="tooltip" title="{{ __('Edit Email') }}">
                    <i class="ti ti-pencil"></i>
                      </a>

                      {!! Form::open(['method' => 'GET', 'class' => 'mb-0', 'url' => [url('email/marketing/delete')], 'id' => 'delete-form-'.$emailMarketing->id]) !!}
                      <input type="hidden" name="id" value="{{ $emailMarketing->id }}" id="">
                      <button type="submit" class="btn px-2 py-2 btn-danger text-white bs-pass-para" data-bs-toggle="tooltip" title="{{ __('Delete') }}">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="padding-left: 10px; font-size: 14px;">
                                                                    ...
                                                                    {{ $users_with_roles[$emailMarketing->type] }}
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="padding-left: 10px; font-size: 14px;">
                                                                    {!! $emailMarketing->email_content !!}
                                                                </td>
                                                            </tr>


                                                            <tr class="{{ $emailMarketing->type == 'Project Director' || $emailMarketing->type == 'Project Manager' || \Auth::user()->can('level 2') ? 'd-none' : ''}}">
                                                                <td class="" style="width: 100px; font-size: 14px;">
                                                                    {{ __('Region') }}
                                                                </td>
                                                                <td class="" style="padding-left: 10px; font-size: 14px;">
                                                                {{ $regions[$emailMarketing->region_id] ?? '' }}
                                                                </td>
                                                            </tr>

                                                            <tr class="{{ $emailMarketing->type == 'Project Director' || $emailMarketing->type == 'Project Manager' || $emailMarketing->type == 'Region Manager' || \Auth::user()->can('level 1') || \Auth::user()->can('level 2') || \Auth::user()->can('level 3')? 'd-none' : ''}}">
                                                                <td class="" style="width: 100px; font-size: 14px;">
                                                                    {{ __('Branch') }}
                                                                </td>
                                                                <td class="" style="padding-left: 10px; font-size: 14px;">
