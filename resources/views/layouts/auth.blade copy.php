...
<div class="auth-wrapper auth-v3 ">
    ...
    <div class="auth-content">
        <nav class="navbar navbar-expand-md navbar-light default d-none">
            <div class="container-fluid pe-2">
                <a class="navbar-brand" href="#">
                {{--                    <img src="{{ asset('assets/images/logo-dark.png') }}" alt="logo"/>--}}
                    @if($mode_setting['cust_darklayout'] && $mode_setting['cust_darklayout'] == 'on' )
                        <img src="{{ $logo . '/' . (isset($company_logos) && !empty($company_logos) ? $company_logos : 'logo-dark.png') }}"
                             alt="{{ config('app.name', 'ERPGo-SaaS') }}" class="logo" style="width: 150px">
                    @else
        ...
        <div class="card">
            <div class="row align-items-center text-start">
                ...
                <div class="col-xl-6 img-card-side d-none">
