...
<script>
    ...
    formData.append("deal_id", "{{ $deal->id }}"); // Assuming you're using Blade templating engine
})
    ...
    var mockFile = {
        ...
        size: {
            {
                \
                File::size(storage_path('deal_files/'.$file->file_path))
            }
        }
    };
        ...
        <div class="row">
            <div class="col-xl-3">
                <div class="card sticky-top" style="top:30px">
                    <div class="list-group list-group-flush" id="deal-sidenav">
                        ...
                        <a href="#users_products" class="list-group-item list-group-item-action border-0">{{__('Users').' | '.__('Courses')}}
                            <div class="float-end"><i class="ti ti-chevron-right"></i></div>
                        </a>
            ...
            <div class="col-xl-9">
                ...
                <div id="applications" class="card">
                    <div class="card-header">
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <div class="float-end">
                                <a href="#" data-size="lg" data-url="{{ route('deals.application.create',$deal->id) }}" data-ajax-popup="true" data-bs-toggle="tooltip" title="{{__('Add Application')}}" class="btn btn-sm btn-primary">
                                    <i class="ti ti-plus"></i>
                                </a>
                            </div>
                            @endcan
                            ...
                            <table class="table table-hover mb-0">
                                ...
                                <tbody>
                                    @forelse ($applications as $application)
                                        <tr>
                                            <td>{{__($application->application_key)}}</td>
                                            <td>{{__($application->getUniversity($application->university_id)->name) }}</td>
                                            <td>{{__($application->course)}}</td>
                                            <td>{{__($application->status)}}</td>
                                            <td>
                                                @can('edit application')
                                                <div class="action-btn bg-info ms-2">
                                                    <a href="#" class="" data-title="{{__('Edit Application')}}" data-url="{{route('deals.application.edit', $application->id)}}" data-ajax-popup="true" data-bs-toggle="tooltip" title="{{__('Edit')}}"><i class="ti ti-pencil text-white"></i></a>
                                                </div>
                                                @endcan
                                                @can('delete application')
                                                <div class="action-btn bg-danger ms-2">
                                                    {!! Form::open(['method' => 'DELETE', 'route' => ['deals.application.destroy', $application->id]]) !!}
                                                    <a href="#" class="mx-3 btn btn-sm  align-items-center bs-pass-para" data-bs-toggle="tooltip" title="{{__('Delete')}}"><i class="ti ti-trash text-white"></i></a>
                                                    {!! Form::close() !!}
                                                </div>
                                                @endcan
                            ...
                            <div class="card">
                                ...
                                <div class="card-header">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <h5>{{__('Courses')}}</h5>
                                        <div class="float-end">
                                            <a data-size="md" data-url="{{ route('deals.courses.edit',$deal->id) }}" data-ajax-popup="true" data-bs-toggle="tooltip" title="{{__('Add Course')}}" class="btn btn-sm btn-primary">
                                                <i class="ti ti-plus"></i>
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-hover mb-0">
                                            ...
                                            <tbody>
                                                @foreach($deal->courses() as $course)
                                                <tr>
                                                    <td>
                                                        {{$course->name}}
                                                    </td>
                                                    ...
                                                    <td>
                                                        <div class="action-btn bg-danger ms-2">
                                                            {!! Form::open(['method' => 'DELETE', 'route' => ['deals.courses.destroy', $deal->id,$course->id]]) !!}
                                                            <a href="#" class="mx-3 btn btn-sm  align-items-center bs-pass-para" data-bs-toggle="tooltip" title="{{__('Delete')}}"><i class="ti ti-trash text-white"></i></a>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <input type="text" class="form form-control deal-drive-link" placeholder="Drive Link" value={{$deal->drive_link}}>
                                    <input type="hidden" class="deal-drive-url" value="{{ route('deals.drive.link', $deal->id) }}">
                                    <input type="hidden" class="deal-id" value="{{ $deal->id }}">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div id="files" class="card">
                    ...
                    <div class="card-body">
                        <div class="col-md-12">
                            <form action="{{route('deals.file.upload',$deal->id)}}" id="dropzonewidget" class="dropzone top-5-scroll browse-file" enctype="multipart/form-data" method="POST">
                            <input type="hidden" class="deal_id" name="deal_id" value={{$deal->id}}>
                            @csrf
                            </form>
                        </div>
