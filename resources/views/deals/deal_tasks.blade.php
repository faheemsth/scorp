                            ...
                            @endif
                                ...
                                <div class="col-md-3 mt-2">
                                    ...
                                    <select class="form form-control select2" id="status444" name="status[]" multiple style="width: 95%;">
                                        ...
                                        <option value="1" <?= isset($_GET['status']) &&  in_array(1,$_GET['status']) ? 'selected' : '' ?>>Completed</option>
                                        <option value="0" <?= isset($_GET['status']) && in_array(0,$_GET['status']) ? 'selected' : '' ?>>On Going</option>
                                        <option value="2" <?= isset($_GET['status']) && in_array(2,$_GET['status']) ? 'selected' : '' ?>>Overdue</option>
                                    </select>
                                </div>
