...
styl
    ...
    <ul class="navbar-nav  sidebar sidebar-dark accordion" id="accordionSidebar" style="background-color: #313949;">
        ...
        <li class="nav-item dashboard">
            <a class="nav-link {{ Request::segment(1) == 'crm-dashboard' || Request::segment(1) == 'hrm-dashboard' ? '' : 'collapsed' }}" href="#" data-toggle="collapse" data-target="#collapseone" aria-expanded="true" aria-controls="collapseone">
                <img src="{{ asset('assets/cs-theme/icons/Group 138.png') }}" width="15px" height="15px" style="margin-top:-10px" alt="" srcset="">
                <span>{{ __('Dashboard') }}</span>
            </a>
            <div id="collapseone" class="collapse {{ Request::segment(1) == 'crm-dashboard' || Request::segment(1) == 'hrm-dashboard' ? 'show' : '' }}" aria-labelledby="headingTwo" data-parent="#accordionSidebar" style="display: block;">
        ...
        <li class="d-none nav-item ">
            <a class="nav-link {{ Request::segment(1) == 'account-dashboard' ? ' ' : 'collapsed' }}" href="#" data-toggle="collapse" data-target="#collapsesaccount" aria-expanded="true" aria-controls="collapsesaccount">
                <span>{{ __('Accounting ') }}</span>
            </a>
            <div id="collapsesaccount" class="collapse {{ Request::segment(1) == 'account-dashboard' ? 'show' : '' }}" aria-labelledby="headingacc" data-parent="#accordionSidebar">
                <div class="  collapse-inner rounded">
                    <ul>
        ...
        <li class="emp nav-item {{ Request::route()->getName() == 'organizaiton.list' || Request::route()->getName() == 'organization.index' || Request::route()->getName() == 'organization.show' ? ' active' : '' }}">
...
<li class="nav-item">
    <a class="nav-link {{ Request::segment(1) == 'branch' || Request::segment(1) == 'users' || (Request::segment(1) == 'user' && Request::segment(2) == 'employees') || Request::segment(1) == 'region' ? '' : 'collapsed' }}" href="#" data-toggle="collapse" data-target="#collapsehrm" aria-expanded="true" aria-controls="collapsehrm">
        <img src="{{ asset('assets/cs-theme/icons/hrm.png') }}" width="23px" style="margin-top:-5px" alt="" srcset="">
        <span>{{ __('HRM System') }}</span>
    </a>
    <div id="collapsehrm" class="collapse {{ Request::segment(1) == 'branch' || Request::segment(1) == 'users' || (Request::segment(1) == 'user' && Request::segment(2) == 'employees') || Request::segment(1) == 'region' ? 'show' : '' }}" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        <div class="  collapse-inner rounded">
            <ul>
                @can('manage user')
        ...
        <div class="  collapse-inner rounded">
            <ul>
                <li class="emp nav-item {{ Request::segment(1) == 'analysis' ? ' active' : '' }}">
                    <a class="collapse-item" href="{{ url('/analysis') }}" style="color:white; font-size: 13px;">
            ...
            <ul class="d-none">
                @can('expense report')
                <li class="emp nav-item {{ Request::route()->getName() == 'report.expense.summary' ? ' active' : '' }}">
                ...
                <li class=" emp nav-item {{ Request::route()->getName() == 'report.income.vs.expense.summary' ? ' active' : '' }}">
                ...
                <li class="emp nav-item {{ Request::route()->getName() == 'report.account.statement' ? ' active' : '' }}">
                    <a class="collapse-item" href="{{ route('report.account.statement') }}" style="color: white; font-size: 13px;">{{ __('Account Statement') }}</a>
                </li>
                @endcan
                @can('invoice report')
                <li class="emp nav-item {{ Request::route()->getName() == 'report.invoice.summary' ? ' active' : '' }}">
                ...
                @endcan
                @can('stock report')
                <li class="emp nav-item {{ Request::route()->getName() == 'report.product.stock.report' ? ' active' : '' }}">
                ...
                <li class="emp nav-item {{ Request::route()->getName() == 'transaction.index' ? ' active' : '' }}">
                    <a class="collapse-item" href="{{ route('transaction.index') }}" style="color: white; font-size: 13px;">{{ __('Transaction') }}</a>
                </li>
                @endcan
                @can('income report')
                <li class="emp nav-item {{ Request::route()->getName() == 'report.income.summary' ? ' active' : '' }}">
                    <a class="collapse-item" href="{{ route('report.income.summary') }}" style="color: white; font-size: 13px;">{{ __('Income Summary') }}</a>
                </li>
                @endcan
                @can('tax report')
                <li class="emp nav-item {{ Request::route()->getName() == 'report.tax.summary' ? ' active' : '' }}">
...
<li class="d-none nav-item">
    ...
    <a class="nav-link  {{ Request::segment(1) == 'project' ||
                    ...
                    Request::segment(1) == 'project_report'
                        ? ''
                        : 'collapsed' }}" href="#" data-toggle="collapse" data-target="#collapseprosys" aria-expanded="true" aria-controls="collapseprosys">
        <span>{{ __('Project System') }}</span>
    </a>
    <div id="collapseprosys" class="collapse {{ Request::segment(1) == 'project' ||
                        Request::segment(1) == 'bugs-report' ||
                        Request::segment(1) == 'bugstatus' ||
                        Request::segment(1) == 'project-task-stages' ||
                        Request::segment(1) == 'calendar' ||
        ...
        <div class="  collapse-inner rounded">
            ...
            <ul>
                @can('manage project')
                <li class="emp nav-item  {{ Request::segment(1) == 'project' || Request::route()->getName() == 'projects.list' || Request::route()->getName() == 'projects.list' || Request::route()->getName() == 'projects.index' || Request::route()->getName() == 'projects.show' || request()->is('projects/*') ? 'active' : '' }}">
                ...
                <li class="emp nav-item  {{ Request::segment(1) == 'time-tracker' ? 'active open' : '' }}">
                    <a class="collapse-item" style="color: white; font-size: 13px;" href="{{ route('time.tracker') }}">{{ __('Tracker') }}</a>
                </li>
                @endif
                @if (\Auth::user()->type == 'company' || \Auth::user()->type == 'employee')
                <li class="emp nav-item  {{ Request::route()->getName() == 'project_report.index' || Request::route()->getName() == 'project_report.show' ? 'active' : '' }}">
                ...
                <li class="emp nav-item d-none {{ Request::segment(1) == 'bugstatus' || Request::segment(1) == 'project-task-stages' ? 'active dash-trigger' : '' }}">
...
{{-- //// --}}
<li class="d-none nav-item ">
    <a class="nav-link {{ Request::segment(1) == 'warehouse' || Request::segment(1) == 'purchase' || Request::segment(2) == 'pos.barcode' || Request::segment(1) == 'pos.print' || Request::segment(1) == 'pos.show' ? ' ' : 'collapsed' }}" href="#" data-toggle="collapse" data-target="#collapsepos" aria-expanded="true" aria-controls="collapsepos">


        <span>{{ __('POS System') }}</span>
    </a>
    <div id="collapsepos" class="collapse {{ Request::segment(1) == 'warehouse' || Request::segment(1) == 'purchase' || Request::segment(2) == 'pos.barcode' || Request::segment(1) == 'pos.print' || Request::segment(1) == 'pos.show' ? 'show' : '' }}" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        <div class="  collapse-inner rounded">
            <ul>
                @can('manage warehouse')
                <li class="emp nav-item {{ Request::route()->getName() == 'warehouse.index' || Request::route()->getName() == 'warehouse.show' ? ' active' : '' }}">
                    <a class="collapse-item" style="color: white; font-size: 13px;" href="{{ route('warehouse.index') }}">{{ __('Warehouse') }}</a>
                </li>
                @endcan
                @can('manage purchase')
                <li class="emp nav-item {{ Request::route()->getName() == 'purchase.index' || Request::route()->getName() == 'purchase.create' || Request::route()->getName() == 'purchase.edit' || Request::route()->getName() == 'purchase.show' ? ' active' : '' }}">
                    <a class="collapse-item" style="color: white; font-size: 13px;" href="{{ route('purchase.index') }}">{{ __('Purchase') }}</a>
                </li>
                @endcan
                @can('manage pos')
                <li class="emp nav-item {{ Request::route()->getName() == 'pos.index' ? ' active' : '' }}">
                    <a class="collapse-item" style="color: white; font-size: 13px;" href="{{ route('pos.index') }}">{{ __(' Add POS') }}</a>
                </li>

                <li class="emp nav-item {{ Request::route()->getName() == 'pos.report' || Request::route()->getName() == 'pos.show' ? ' active' : '' }}">
                    <a class="collapse-item" style="color: white; font-size: 13px;" href="{{ route('pos.report') }}">{{ __('POS') }}</a>
                </li>
                @endcan
                @can('create barcode')
                <li class="emp nav-item {{ Request::route()->getName() == 'pos.barcode' || Request::route()->getName() == 'pos.print' ? ' active' : '' }}">
                    <a class="collapse-item" style="color: white; font-size: 13px;" href="{{ route('pos.barcode') }}">{{ __('Print Barcode') }}</a>
                </li>
                @endcan
                @can('manage pos')
                <li class="emp nav-item {{ Request::route()->getName() == 'pos-print-setting' ? ' active' : '' }}">
...
<li class="d-none nav-item ">
    <a class="nav-link {{ Request::segment(1) == 'users' || Request::segment(1) == 'roles' || Request::segment(2) == 'employees' || Request::segment(1) == 'clients' ? ' ' : 'collapsed' }}" href="#" data-toggle="collapse" data-target="#collapsesu" aria-expanded="true" aria-controls="collapsesu">
        <img src="{{ asset('assets/cs-theme/icons/Vector (2).png') }}" width="14px" height="14px" style="margin-top:-8px" alt="" srcset="">

        <span>{{ __('Users') }}</span>
    </a>
    <div id="collapsesu" class="collapse {{ Request::segment(1) == 'branch' || Request::segment(1) == 'users' || (Request::segment(1) == 'user' && Request::segment(2) == 'employees') || Request::segment(1) == 'roles' || Request::segment(1) == 'region' ? 'show' : '' }}" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        <div class="  collapse-inner rounded">
            <ul>
        ...
        <div class="  collapse-inner rounded">
            <ul>
                ...
                <li style="" class="emp nav-item {{ Request::segment(1) == 'stages' || Request::segment(1) == 'labels' || Request::segment(1) == 'sources' || Request::segment(1) == 'lead_stages' || Request::segment(1) == 'pipelines' || Request::segment(1) == 'product-category' || Request::segment(1) == 'product-unit' || Request::segment(1) == 'payment-method' || Request::segment(1) == 'custom-field' || Request::segment(1) == 'chart-of-account-type' ? 'active dash-trigger' : '' }}">
                    ...
                    <a class="collapse-item" style="color:white; font-size: 13px;" href="{{ route('stages.index') }}   ">
                ...
                <li class="d-none emp nav-item {{ Request::segment(1) == 'email_template_lang' ? 'active' : '' }}">
...
<li class=" nav-item {{ Request::segment(1) == 'support' ? 'active' : '' }}">
    <a href="{{ route('support.index') }}" class="nav-link">
        <img src="{{ asset('assets/cs-theme/icons/Layer_1 (4).png') }}" id="icon1" width="15px" height="15px" style="margin-top:-6px" alt="" srcset="">
        <img src="{{ asset('assets/cs-theme/icons/Layer_1(4.1).svg') }}" id="icon2" width="15px" height="15px" style="margin-top:-6px" alt="" srcset="">
