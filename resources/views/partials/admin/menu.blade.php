                                ...
                                <ul>
                                    ...
                                    @if (\Auth::user()->show_hrm() == 1)
                                        <li
                                            ...
                                            <a class="collapse-item" style="color: white; font-size: 13px;"
                                                href="{{ route('hrm.dashboard') }}">
                                                <img src="{{ asset('assets/cs-theme/icons/Layer_1.png') }}"
                        ...
                        <li
                            ...
                            <div id="collapsetwo" class="collapse" aria-labelledby="headingTwo"
                                ...
                                <div class="  collapse-inner rounded">
                                    <ul>
                                        <li
                                            class="{{ Request::segment(1) == 'employee' ? 'active dash-trigger' : '' }} ">
                                                    ...
                                                    <div class="  collapse-inner rounded">
                                                        <ul>
                                                            @can('manage set salary')
                                                                <li
                                                                    class="{{ request()->is('setsalary*') ? 'active' : '' }}">
                                                                    <a class="collapse-item"
                                                    ...
                                                    <div class="  collapse-inner rounded">
                                                        <ul
                                                            ...
                                                            @can('manage appraisal')
                                                                <li
                                                                    class="{{ request()->is('appraisal*') ? 'active' : '' }}">
                                                                    <a class="collapse-item"
                                                ...
                                                <div id="collapseUtilities" class="collapse"
                                                    ...
                                                    <div class="  collapse-inner rounded">
                                                        <ul>
                                                            ...
                                                            @can('manage trainer')
                                                                <li
                                                                    class="{{ request()->is('trainer*') ? 'active' : '' }}">
                                                                    <a class="collapse-item"
                                                ...
                                                <div id="collapseUtilities" class="collapse"
                                                    ...
                                                    <div class="  collapse-inner rounded">
                                                        <ul>
                                                            ...
                                                            @can('manage travel')
                                                                <li
                                                                    class=" {{ request()->is('travel*') ? 'active' : '' }}">
                                                                    <a class="collapse-item"
                                                                        style="color: white; font-size: 13px;"
                                                            ...
                                                            @can('manage warning')
                                                                <li
                                                                    class=" {{ request()->is('warning*') ? 'active' : '' }}">
                                                                    <a class="collapse-item"
                                                                        style="color: white; font-size: 13px;"
                                            ...
                                            <li
                                                ...
                                                <a class="collapse-item" style="color: white; font-size: 13px;"
                                                    ...
                                                    <img src="{{ asset('assets/cs-theme/icons/Layer_1.png') }}"
                                                        id="icon1" width="15px" height="15px"
                                                        style="margin-top:-10px" alt="" srcset="">
                                                    <img src="{{ asset('assets/cs-theme/icons/leadsblue.png') }}"
                                                        id="icon2" width="15px" height="15px"
                                                        style="margin-top:-8px" alt="" srcset="">
                                            ...
                                            <li
                                                ...
                                                <a class="collapse-item" style="color: white; font-size: 13px;"
                                                    ...
                                                    <img src="{{ asset('assets/cs-theme/icons/edit-icon 1.png') }}"
                                                        id="icon1" width="15px" height="15px"
                                                        style="margin-top:-10px" alt="" srcset="">
                                                    <img src="{{ asset('assets/cs-theme/icons/admiblue.png') }}"
                                                        id="icon2" width="15px" height="15px"
                                                        style="margin-top:-8px" alt="" srcset="">
                                                    Admissions</a>
                                            </li>
                                            ...
                                            <li
                                                ...
                                                <a class="collapse-item" style="color: white; font-size: 13px;"
                                                    ...
                                                    <img src="{{ asset('assets/cs-theme/icons/result-pass-icon 1.png') }}"
                                                        id="icon1" width="15px" height="15px"
                                                        style="margin-top:-10px" alt="" srcset="">
                                                    <img src="{{ asset('assets/cs-theme/icons/appblue.png') }}"
                                                        id="icon2" width="15px" height="15px"
                                                        style="margin-top:-8px" alt="" srcset="">
                                            ...
                                            <li
                                                ...
                                                <a class="collapse-item" style="color: white; font-size: 13px;"
                                                    ...
                                                    <img src="{{ asset('assets/cs-theme/icons/organization-01-1 1.png') }}"
                                                        id="icon1" width="15px" height="15px"
                                                        style="margin-top:-10px" alt="" srcset="">
                                                    <img src="{{ asset('assets/cs-theme/icons/orgblue.png') }}"
                                                        id="icon2" width="15px" height="15px"
                                                        style="margin-top:-8px" alt="" srcset="">
                            ...
                            <div id="collapsenine" class="collapse" aria-labelledby="headingUtilities"
                                ...
                                <div class="  collapse-inner rounded">
                                    ...
                                    <ul
                                        ...
                                        @can('manage pos')
                                            <li
                                                class=" {{ Request::route()->getName() == 'pos.index' ? ' active' : '' }}">
                                                <a class="collapse-item" style="color: white; font-size: 13px;"
                                ...
                                <div class="  collapse-inner rounded">
                                    <ul>
                                        @if (Gate::check('manage company settings'))
                                            <li
                                                class="emp {{ Request::segment(1) == 'settings' ? ' active' : '' }}">
            ...
            <img src="{{ asset('assets/cs-theme/icons/callblue.png') }}" id="icon2" width="15px" height="15px" style="margin-top:-8px" alt="" srcset=""> --}}
                                ...
                                <li
                                    ...
                                    <a class="collapse-item" style="color:white; font-size: 13px;"
                                        href="{{ route('university.index') }}">
                                        <img src="{{ asset('assets/cs-theme/icons/Layer_1 (7).png') }}"
                                            width="15px" id="icon1" height="15px"
                                            style="margin-top:-10px" alt="" srcset="">
                                        <img src="{{ asset('assets/cs-theme/icons/toolkitblue.png') }}"
                                            id="icon2" width="15px" height="15px" style="margin-top:-8px"
                                            alt="" srcset="">
    ...
    <a class="collapse-item" style="color:white; font-size: 13px;" href="{{ route('contract.index') }}">{{ __('Contract') }}</a>
                                ...
                                <li
                                    ...
                                    <a class="collapse-item" style="color:white; font-size: 13px;"
                                        href="{{ route('organization.index') }}">
                                        <img src="{{ asset('assets/cs-theme/icons/organization-01-1 1.png') }}"
                                            id="icon1" width="19px" height="19px"
                                            style="margin-top:-10px" alt="" srcset="">
                                        <img src="{{ asset('assets/cs-theme/icons/orgblue.png') }}" id="icon2"
                                            width="19px" height="19px" style="margin-top:-8px" alt=""
                                            srcset="">
                ...
                @if (\Auth::user()->type == 'super admin')
                    <li
                        class="nav-item {{ Request::segment(1) == 'users' || Request::segment(1) == 'roles' || Request::segment(1) == 'clients' ? ' active dash-trigger' : '' }}">
                        <a class="nav-link collapsed" href="#" data-toggle="collapse"
                                    ...
                                    @can('manage user')
                                        <li
                                            ...
                                            <a class="collapse-item" style="color:white; font-size: 13px;"
                                                ...
                                                <img src="{{ asset('assets/cs-theme/icons/Layer_1 (5).png') }}"
                                                    id="icon1" width="15px" height="15px"
                                                    style="margin-top:-8px" alt="" srcset="">
                                                <img src="{{ asset('assets/cs-theme/icons/brandblue.png') }}"
                                                    id="icon2" width="15px" height="15px"
                                                    style="margin-top:-8px" alt="" srcset="">
                                    ...
                                    @can('manage role')
                                        <li
                                            ...
                                            <a class="collapse-item" style="color:white; font-size: 13px;"
                                                ...
                                                <img src="{{ asset('assets/cs-theme/icons/Layer_1 (6).png') }}"
                                                    id="icon1" width="15px" height="15px"
                                                    style="margin-top:-8px" alt="" srcset="">
                                                <img src="{{ asset('assets/cs-theme/icons/rolesblue.png') }}"
                                                    id="icon2" width="15px" height="15px"
                                                    style="margin-top:-8px" alt="" srcset="">
                            ...
                            <div id="collapseten"
                                ...
                                <div class="  collapse-inner rounded">
                                    <ul>
                                        ...
                                        @if (Gate::check('manage company settings'))
                                            <li
                                                class="emp {{ Request::segment(1) == 'settings' ? ' active show' : '' }}">
                                                <a href="{{ route('settings') }}" class="collapse-item"
                                                    style="color: white; font-size: 13px;">
                                                    <i class="fa-solid fa-gears" id="icon1"
                                                        style="color: #ffffff;font-size: 15px;"></i>
                ...
                @if (Gate::check('manage system settings') ||
                    ...
                    <li
                        class="nav-item d-none {{ Request::route()->getName() == 'systems.index' ? ' active' : '' }}">
                        <a class="nav-link collapsed" href="#" data-toggle="collapse"
                            data-target="#collapsesu" aria-expanded="true" aria-controls="collapsesu">
                            <img src="{{ asset('assets/cs-theme/icons/settings-3110 1.png') }}" width="15px"
                                height="15px" style="margin-top:-10px" alt="" srcset="">
                        ...
                        <div id="collapsesu"
                            ...
                            <div class="  collapse-inner rounded">
                                <ul>
                                    @if (Gate::check('manage system settings'))
                                        <li
                                            class="nav-item {{ Request::segment(1) == 'settings' ? 'active' : '' }}">
                                    ...
                                    @endif
                                    <li
                                        class="nav-item {{ Request::segment(1) == 'email_template' ? 'active' : '' }}">
