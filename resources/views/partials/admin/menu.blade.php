    ...
    @if (\Auth::user()->type != 'client')
        ...
        <ul style="list-style: none">
            ...
            @if (Auth::user()->type == 'company' ||
                ...
                <li
                    class="nav-item {{  ( Request::segment(1) == null || Request::segment(1) == 'crm-dashboard' ||Request::segment(1) == 'account-dashboard' || Request::segment(1) == 'income report'
                            ...
                            <ul>
                                            ...
                                            <div class="  collapse-inner rounded">
                                                <ul>
                                                    @can('show account dashboard')
                                                        <li
                                                            class="{{ Request::segment(1) == null || Request::segment(1) == 'account-dashboard' ? ' active' : '' }}">
                                                    ...
                                                    @if (Gate::check('income report') ||
                                                        ...
                                                        <li
                                                            class="nav-item {{ Request::segment(1) == 'report' ? 'active dash-trigger ' : '' }}">
                                                            <a class="nav-link collapsed" href="#"
                                                                data-toggle="collapse" data-target="#collapsesys"
                                                                aria-expanded="true" aria-controls="collapsesys">

                                                                <span>{{ __('Reports') }}</span>
                                                            </a>
                                                            <div id="collapsesys" class="collapse"
                                                                ...
                                                                <div class="  collapse-inner rounded">
                                                                    <ul>
                                                                        @can('expense report')
                                                                            <li
                                                                                class="{{ Request::route()->getName() == 'report.expense.summary' ? ' active' : '' }}">
                                                                        ...
                                                                        @can('income vs expense report')
                                                                            <li
                                                                                class="{{ Request::route()->getName() == 'report.income.vs.expense.summary' ? ' active' : '' }}">
                                                                                <a class="collapse-item"
                                                                        ...
                                                                        @can('statement report')
                                                                            <li
                                                                                class=" {{ Request::route()->getName() == 'report.account.statement' ? ' active' : '' }}">
                                                                                <a class="collapse-item"
                                                                        ...
                                                                        @can('invoice report')
                                                                            <li
                                                                                class=" {{ Request::route()->getName() == 'report.invoice.summary' ? ' active' : '' }}">
                                                                                <a class="collapse-item"
                                                                        ...
                                                                        @can('bill report')
                                                                            <li
                                                                                class=" {{ Request::route()->getName() == 'report.bill.summary' ? ' active' : '' }}">
                                                                                <a class="collapse-item"
                                                                        ...
                                                                        @can('stock report')
                                                                            <li
                                                                                class=" {{ Request::route()->getName() == 'report.product.stock.report' ? ' active' : '' }}">
                                                                                <a class="collapse-item"
                                                                        ...
                                                                        @can('manage transaction')
                                                                            <li
                                                                                class=" {{ Request::route()->getName() == 'transaction.index' ? ' active' : '' }}">
                                                                                <a class="collapse-item"
                                                                        ...
                                                                        @can('income report')
                                                                            <li
                                                                                class=" {{ Request::route()->getName() == 'report.income.summary' ? ' active' : '' }}">
                                                                                <a class="collapse-item"
                                                                        ...
                                                                        @can('tax report')
                                                                            <li
                                                                                class=" {{ Request::route()->getName() == 'report.tax.summary' ? ' active' : '' }}">
                                                                                <a class="collapse-item"
                                                            ...
                                                            <div id="collapsesys" class="collapse"
                                                                ...
                                                                <div class="  collapse-inner rounded">
                                                                    <ul>
                                                                        ...
                                                                        <li
                                                                            class="{{ request()->is('reports-monthly-attendance') ? 'active' : '' }}">
                                                                            <a class="collapse-item"
                                ...
                                @if (\Auth::user()->show_project() == 1)
                                    @can('show project dashboard')
                                        <li
                                            class="{{ Request::route()->getName() == 'project.dashboard' ? ' active' : '' }}">
            ...
            @if (\Auth::user()->show_hrm() == 1 || Auth::user()->type == 'team')
                ...
                @if (Gate::check('manage employee') || Gate::check('manage setsalary'))
                    <li
                        class="nav-item d-none {{ Request::segment(1) == 'holiday-calender' ||
                            ...
                            <div class="  collapse-inner rounded">
                                <ul>
                                    <li class="{{ Request::segment(1) == 'employee' ? 'active dash-trigger' : '' }} ">
                                        @if (\Auth::user()->type == 'Employee')
                                            ...
                                            <a class="collapse-item"
                                                ...
                                                style="color:white; font-size: 13px;">{{ __('Employee') }}</a>
                                        @else
                                            <a class="collapse-item" href="{{ route('employee.index') }}"
                                                style="color:white; font-size: 13px;"> {{ __('Employee Setup') }}</a>
                                        @endif
                                    </li>
                                    @if (Gate::check('manage set salary') || Gate::check('manage pay slip'))
                                        <li
                                            class="nav-item {{ Request::segment(1) == 'setsalary' || Request::segment(1) == 'payslip' ? 'active dash-trigger' : '' }}">
                                            <a class="nav-link collapsed" href="#" data-toggle="collapse"
                                                        ...
                                                        @can('manage set salary')
                                                            <li class="{{ request()->is('setsalary*') ? 'active' : '' }}">
                                                                <a class="collapse-item"
                                                                    ...
                                                                    style="color: white; font-size: 13px;">{{ __('Set salary') }}</a>
                                                            </li>
                                                        @endcan
                                                        @can('manage pay slip')
                                                            <li class="{{ request()->is('payslip*') ? 'active' : '' }}">
                                                                <a class="collapse-item"
                                                                    ...
                                                                    style="color: white; font-size: 13px;">{{ __('Payslip') }}</a>
                                                            </li>
                                                        @endcan
                                                    </ul>
                                                </div>
                                    ...
                                    @if (Gate::check('manage leave') || Gate::check('manage attendance'))
                                        <li
                                            class="nav-item {{ Request::segment(1) == 'leave' || Request::segment(1) == 'attendanceemployee' ? 'active dash-trigger' : '' }}">
                                            <a class="nav-link collapsed" href="#" data-toggle="collapse"
                                                data-target="#collapseUtilities" aria-expanded="true"
                                                aria-controls="collapseUtilities">
                                            ...
                                            <div id="collapseUtilities" class="collapse"
                                                ...
                                                <div class="  collapse-inner rounded">
                                                    <ul>
                                                        @can('manage leave')
                                                            <li
                                                                class="{{ request()->is('leave.index*') ? 'active' : '' }}">
                                                                <a class="collapse-item"
                                                                    href="{{ route('leave.index') }}"
                                                                    style="color: white; font-size: 13px;">{{ __('Manage Leave') }}</a>
                                                            </li>
                                                        @endcan
                                                        @can('manage attendance')
                                                            <li class="nav-item {{ Request::segment(1) == 'attendanceemployee' ? 'active dash-trigger' : '' }}"
                                                                ...
                                                                <div id="collapseUtilities" class="collapse"
                                                                    ...
                                                                    <div class="  collapse-inner rounded">
                                                                        <ul>
                                                                            <li
                                                                                class="{{ Request::route()->getName() == 'attendanceemployee.index' ? 'active' : '' }}">
                                                                                <a class="collapse-item"
                                                                                    href="{{ route('attendanceemployee.index') }}"
                                                                                    style="color: white; font-size: 13px;">{{ __('Mark Attendance') }}</a>
                                                                            </li>
                                                                            @can('create attendance')
                                                                                <li
                                                                                    class="{{ Request::route()->getName() == 'attendanceemployee.bulkattendance' ? 'active' : '' }}">

                                                                                    <a class="collapse-item"
                                                                                        href="{{ route('attendanceemployee.bulkattendance') }}"
                                                                                        style="color: white; font-size: 13px;">{{ __('Bulk Attendance') }}</a>
                                                                                </li>
                                                                            @endcan
                                                                        </ul>
                                                                    </div>
                                    ...
                                    @if (Gate::check('manage indicator') || Gate::check('manage appraisal') || Gate::check('manage goal tracking'))
                                        <li class="nav-item {{ Request::segment(1) == 'indicator' || Request::segment(1) == 'appraisal' || Request::segment(1) == 'goaltracking' ? 'active dash-trigger' : '' }}"
                                            ...
                                            <div id="collapseUtilities" class="collapse"
                                                ...
                                                <div class="  collapse-inner rounded">
                                                    <ul
                                                        class="{{ Request::segment(1) == 'indicator' || Request::segment(1) == 'appraisal' || Request::segment(1) == 'goaltracking' ? 'show' : 'collapse' }}">
                                                        @can('manage indicator')
                                                            <li
                                                                class=" {{ request()->is('indicator*') ? 'active' : '' }}">
                                                                <a class="collapse-item"
                                                                    href="{{ route('indicator.index') }}"
                                                                    style="color: white; font-size: 13px;">{{ 'Indicator' }}</a>
                                                            </li>
                                                        @endcan
                                                        @can('manage appraisal')
                                                            <li class="{{ request()->is('appraisal*') ? 'active' : '' }}">
                                                                <a class="collapse-item"
                                                                    ...
                                                                    style="color: white; font-size: 13px;">{{ 'Appraisal' }}</a>
                                                            </li>
                                                        @endcan
                                                        @can('manage goal tracking')
                                                            <li
                                                                class="{{ request()->is('goaltracking*') ? 'active' : '' }}">
                                                                <a class="collapse-item"
                                                                    href="{{ route('goaltracking.index') }}"
                                                                    style="color: white; font-size: 13px;">{{ 'Goal Tracking' }}</a>
                                                            </li>
                                                        @endcan
                                                    </ul>
                                                </div>
                                    ...
                                    @if (Gate::check('manage training') || Gate::check('manage trainer') || Gate::check('show training'))
                                        <li class="nav-item {{ Request::segment(1) == 'trainer' || Request::segment(1) == 'training' ? 'active dash-trigger' : '' }}"
                                            ...
                                            <div id="collapseUtilities" class="collapse"
                                                ...
                                                <div class="  collapse-inner rounded">
                                                    <ul>
                                                        @can('manage training')
                                                            <li
                                                                class=" {{ request()->is('training*') ? 'active' : '' }}">
                                                                <a class="collapse-item"
                                                                    href="{{ route('training.index') }}"
                                                                    style="color: white; font-size: 13px;">{{ 'Training List' }}</a>
                                                            </li>
                                                        @endcan
                                                        @can('manage trainer')
                                                            <li class="{{ request()->is('trainer*') ? 'active' : '' }}">
                                                                <a class="collapse-item"
                                                                    ...
                                                                    style="color: white; font-size: 13px;">{{ 'Trainer' }}</a>
                                                            </li>
                                                        @endcan
                                    ...
                                    @if (Gate::check('manage job') ||
                                        ...
                                        <li
                                            class="nav-item {{ Request::segment(1) == 'job' || Request::segment(1) == 'job-application' || Request::segment(1) == 'candidates-job-applications' || Request::segment(1) == 'job-onboard' || Request::segment(1) == 'custom-question' || Request::segment(1) == 'interview-schedule' || Request::segment(1) == 'career' ? 'active dash-trigger' : '' }}">
                                            <a class="nav-link collapsed" href="#" data-toggle="collapse"
                                                data-target="#collapseUtilities" aria-expanded="true"
                                                aria-controls="collapseUtilities">
                                            ...
                                            <div id="collapseUtilities" class="collapse"
                                                ...
                                                <div class="  collapse-inner rounded">
                                                    <ul>
                                                        @can('manage job')
                                                            <li
                                                                class=" {{ Request::route()->getName() == 'job.index' || Request::route()->getName() == 'job.create' || Request::route()->getName() == 'job.edit' || Request::route()->getName() == 'job.show' ? 'active' : '' }}">
                                                                <a class="collapse-item"
                                                                    style="color: white; font-size: 13px;"
                                                        ...
                                                        @can('create job')
                                                            <li
                                                                class=" {{ Request::route()->getName() == 'job.create' ? 'active' : '' }} ">
                                                                <a class="collapse-item"
                                                                    style="color: white; font-size: 13px;"
                                                        ...
                                                        @can('manage job application')
                                                            <li
                                                                class="{{ request()->is('job-application*') ? 'active' : '' }}">
                                                                <a class="collapse-item"
                                                                    style="color: white; font-size: 13px;"
                                                        ...
                                                        @can('manage job application')
                                                            <li
                                                                class=" {{ request()->is('candidates-job-applications') ? 'active' : '' }}">
                                                                <a class="collapse-item"
                                                                    style="color: white; font-size: 13px;"
                                                        ...
                                                        @can('manage job application')
                                                            <li
                                                                class=" {{ request()->is('job-onboard*') ? 'active' : '' }}">
                                                                <a class="collapse-item"
                                                                    style="color: white; font-size: 13px;"
                                                        ...
                                                        @can('manage custom question')
                                                            <li
                                                                class="  {{ request()->is('custom-question*') ? 'active' : '' }}">
                                                                <a class="collapse-item"
                                                                    style="color: white; font-size: 13px;"
                                                        ...
                                                        @can('show interview schedule')
                                                            <li
                                                                class=" {{ request()->is('interview-schedule*') ? 'active' : '' }}">
                                                                <a class="collapse-item"
                                                                    style="color: white; font-size: 13px;"
                                                ...
                                                <div class="  collapse-inner rounded">
                                                    <ul>
                                                        ...
                                                        @can('manage resignation')
                                                            <li
                                                                class=" {{ request()->is('resignation*') ? 'active' : '' }}">
                                                                <a class="collapse-item"
                                                                    style="color: white; font-size: 13px;"
                                                        ...
                                                        @can('manage promotion')
                                                            <li
                                                                class=" {{ request()->is('promotion*') ? 'active' : '' }}">
                                                                <a class="collapse-item"
                                                                    style="color: white; font-size: 13px;"
                                                        ...
                                                        @can('manage complaint')
                                                            <li
                                                                class=" {{ request()->is('complaint*') ? 'active' : '' }}">
                                                                <a class="collapse-item"
                                                                    style="color: white; font-size: 13px;"
                                                        ...
                                                        @can('manage termination')
                                                            <li
                                                                class=" {{ request()->is('termination*') ? 'active' : '' }}">
                                                                <a class="collapse-item"
                                                                    style="color: white; font-size: 13px;"
                                                        ...
                                                        @can('manage announcement')
                                                            <li
                                                                class=" {{ request()->is('announcement*') ? 'active' : '' }}">
                                                                <a class="collapse-item"
                                                                    style="color: white; font-size: 13px;"
                                                        ...
                                                        @can('manage holiday')
                                                            <li
                                                                class=" {{ request()->is('holiday*') || request()->is('holiday-calender') ? 'active' : '' }}">
                                                                <a class="collapse-item"
                                                                    style="color: white; font-size: 13px;"
                            ...
                            <div class="  collapse-inner rounded">
                                <ul>
                                    ...
                                    @if (Gate::check('manage bank account') || Gate::check('manage bank transfer'))
                                        <li
                                            class="nav-item {{ Request::segment(1) == 'bank-account' || Request::segment(1) == 'bank-transfer' ? 'active dash-trigger' : '' }}">
                                            <a class="nav-link collapsed" href="#" data-toggle="collapse"
                                                data-target="#collapseUtilities" aria-expanded="true"
                                                aria-controls="collapseUtilities">
                                            ...
                                            <div id="collapseUtilities" class="collapse"
                                                ...
                                                <div class="  collapse-inner rounded">
                                                    <ul>
                                                        <li
                                                            class="{{ Request::route()->getName() == 'bank-account.index' || Request::route()->getName() == 'bank-account.create' || Request::route()->getName() == 'bank-account.edit' ? ' active' : '' }}">
                                                            <a class="collapse-item"
                                                                style="color: white; font-size: 13px;"
                                                                href="{{ route('bank-account.index') }}">{{ __('Account') }}</a>
                                                        </li>
                                                        <li
                                                            class="{{ Request::route()->getName() == 'bank-transfer.index' || Request::route()->getName() == 'bank-transfer.create' || Request::route()->getName() == 'bank-transfer.edit' ? ' active' : '' }}">
                                                            <a class="collapse-item"
                                                                style="color: white; font-size: 13px;"
                                    ...
                                    @if (Gate::check('manage invoice') || Gate::check('manage revenue') || Gate::check('manage credit note'))
                                        <li
                                            class="nav-item {{ Request::segment(1) == 'invoice' || Request::segment(1) == 'revenue' || Request::segment(1) == 'credit-note' ? 'active dash-trigger' : '' }}">
                                            <a class="nav-link collapsed" href="#" data-toggle="collapse"
                                                data-target="#collapseUtilities" aria-expanded="true"
                                                aria-controls="collapseUtilities">
                                                <span>{{ __('Income') }}</span>
                                    ...
                                    @if (Gate::check('manage bill') || Gate::check('manage payment') || Gate::check('manage debit note'))
                                        <li
                                            class="nav-item {{ Request::segment(1) == 'bill' || Request::segment(1) == 'payment' || Request::segment(1) == 'debit-note' ? 'active dash-trigger' : '' }}">
                                            <a class="nav-link collapsed" href="#" data-toggle="collapse"
                                                data-target="#collapseUtilities" aria-expanded="true"
                                                aria-controls="collapseUtilities">
                                    ...
                                    @if (Gate::check('manage chart of account') ||
                                            ...
                                            Gate::check('trial balance report'))
                                        <li
                                            class="nav-item {{ Request::segment(1) == 'chart-of-account' || Request::segment(1) == 'journal-entry' || Request::segment(2) == 'ledger' || Request::segment(2) == 'balance-sheet' || Request::segment(2) == 'trial-balance' ? 'active dash-trigger' : '' }}">
                                            <a class="nav-link collapsed" href="#" data-toggle="collapse"
                                                data-target="#collapseUtilities" aria-expanded="true"
                                                aria-controls="collapseUtilities">
                                            ...
                                            <div id="collapseUtilities" class="collapse"
                                                ...
                                                <div class="  collapse-inner rounded">
                                                    <ul>
                                                        <li
                                                            class="{{ Request::route()->getName() == 'chart-of-account.index' ? ' active' : '' }}">
                                                            <a class="collapse-item"
                                                                style="color: white; font-size: 13px;"
                                                                href="{{ route('chart-of-account.index') }}">{{ __('Chart of Accounts') }}</a>
                                                        </li>
                                                        <li
                                                            class="{{ Request::route()->getName() == 'journal-entry.edit' || Request::route()->getName() == 'journal-entry.create' || Request::route()->getName() == 'journal-entry.index' || Request::route()->getName() == 'journal-entry.show' ? ' active' : '' }}">
                                                            <a class="collapse-item"
                                                                style="color: white; font-size: 13px;"
                                                                href="{{ route('journal-entry.index') }}">{{ __('Journal Account') }}</a>
                                                        </li>
                                                        <li
                                                            class="{{ Request::route()->getName() == 'report.ledger' ? ' active' : '' }}">
                                                            <a class="collapse-item"
                                                                style="color: white; font-size: 13px;"
                                                                href="{{ route('report.ledger') }}">{{ __('Ledger Summary') }}</a>
                                                        </li>
                                                        <li
                                                            class="{{ Request::route()->getName() == 'report.balance.sheet' ? ' active' : '' }}">
                                                            <a class="collapse-item"
                                                                style="color: white; font-size: 13px;"
                                                                href="{{ route('report.balance.sheet') }}">{{ __('Balance Sheet') }}</a>
                                                        </li>
                                                        <li
                                                            class="{{ Request::route()->getName() == 'trial.balance' ? ' active' : '' }}">
                                                            <a class="collapse-item"
                                                                style="color: white; font-size: 13px;"
                                    ...
                                    @if (Gate::check('manage constant tax') ||
                                        ...
                                        <li
                                            class=" {{ Request::segment(1) == 'taxes' || Request::segment(1) == 'product-category' || Request::segment(1) == 'product-unit' || Request::segment(1) == 'payment-method' || Request::segment(1) == 'custom-field' || Request::segment(1) == 'chart-of-account-type' ? 'active dash-trigger' : '' }}">
                                            <a class="collapse-item" style="color: white; font-size: 13px;"
                                    ...
                                    @if (Gate::check('manage print settings'))
                                        <li
                                            class=" {{ Request::route()->getName() == 'print-setting' ? ' active' : '' }}">
                                            <a class="collapse-item" style="color: white; font-size: 13px;"
                        ...
                        <div id="collapsefour" class="collapse" aria-labelledby="headingUtilities"
                            ...
                            <div class="  collapse-inner rounded">
                                <ul
                                    ...
                                    @can('manage task')
                                        <li
                                            class=" {{ Request::route()->getName() == 'deals.get.user.tasks' ? ' active' : '' }}">
                                            <a class="collapse-item" style="color: white; font-size: 13px;"
                                    ...
                                    @can('manage lead')
                                        <li
                                            class=" {{ Request::route()->getName() == 'leads.list' || Request::route()->getName() == 'leads.index' || Request::route()->getName() == 'leads.show' ? ' active' : '' }}">
                                            <a class="collapse-item" style="color: white; font-size: 13px;"
                                    ...
                                    @can('manage client')
                                        <li
                                            class=" {{ Request::route()->getName() == 'clients.index' || Request::segment(1) == 'clients' || Request::route()->getName() == 'clients.edit' ? ' active' : '' }}">
                                            <a class="collapse-item" style="color: white; font-size: 13px;"
                                                href="{{ route('clients.index') }}">
                                            <img src="{{ asset('assets/cs-theme/icons/Layer_1 (1).png') }}" width="15px" height="15px" style="margin-top:-10px" alt="" srcset="">
                                    ...
                                    @can('manage deal')
                                        <li
                                            class=" {{ Request::route()->getName() == 'deals.list' || Request::route()->getName() == 'deals.index' || Request::route()->getName() == 'deals.show' ? ' active' : '' }}">
                                            <a class="collapse-item" style="color: white; font-size: 13px;"
                                                href="{{ route('deals.list') }}">
                                                <img src="{{ asset('assets/cs-theme/icons/edit-icon 1.png') }}" width="15px" height="15px" style="margin-top:-10px" alt="" srcset="">
                                                Admissions</a>
                                        </li>
                                    @endcan
                                    ...
                                    @can('manage application')
                                        <li
                                            class=" {{ Request::route()->getName() == 'applications.index' ? ' active' : '' }}">
                                            <a class="collapse-item" style="color: white; font-size: 13px;"
                                                href="{{ route('applications.index') }}">
                                            <img src="{{ asset('assets/cs-theme/icons/result-pass-icon 1.png') }}" width="15px" height="15px" style="margin-top:-10px" alt="" srcset="">
                                 ...
                                 <a class="collapse-item" style="color: white; font-size: 13px;" href="{{route('form_builder.index')}}">{{__('Form Builder')}}</a>
                                    ...
                                    @can('manage university')
                                        <li
                                            class=" {{ Request::route()->getName() == 'university.list' || Request::route()->getName() == 'university.index' || Request::route()->getName() == 'university.show' ? ' active' : '' }}">
                                            <a class="collapse-item" style="color: white; font-size: 13px;"
                                 ...
                                 <a class="collapse-item" style="color: white; font-size: 13px;" href="{{ route('course.index') }}">{{__('Courses')}}</a>
                                    ...
                                    @can('manage branch')
                                        <li
                                            class=" {{ Request::route()->getName() == 'branch.index' || Request::route()->getName() == 'branch.edit' || Request::route()->getName() == 'branch.show' ? ' active' : '' }}">
                                            <a class="collapse-item" style="color: white; font-size: 13px;"
                                                href="{{ route('branch.index') }}">
                            <img src="{{ asset('assets/cs-theme/icons/Layer_1 (3).png') }}" width="15px" height="15px" style="margin-top:-10px" alt="" srcset="">
                        ...
                        <div id="collapsefive" class="collapse" aria-labelledby="headingUtilities"
                            ...
                            <div class="  collapse-inner rounded">
                                ...
                                <ul>
                                    @can('manage project')
                                        <li
                                            class="  {{ Request::segment(1) == 'project' || Request::route()->getName() == 'projects.list' || Request::route()->getName() == 'projects.list' || Request::route()->getName() == 'projects.index' || Request::route()->getName() == 'projects.show' || request()->is('projects/*') ? 'active' : '' }}">
                                            <a class="collapse-item" style="color: white; font-size: 13px;"
                                    ...
                                    @if (\Auth::user()->type != 'super admin')
                                        <li
                                            class="  {{ Request::segment(1) == 'time-tracker' ? 'active open' : '' }}">
                                            <a class="collapse-item" style="color: white; font-size: 13px;"
                                    ...
                                    @if (\Auth::user()->type == 'company' || \Auth::user()->type == 'employee')
                                        <li
                                            class="  {{ Request::route()->getName() == 'project_report.index' || Request::route()->getName() == 'project_report.show' ? 'active' : '' }}">
                                            <a class="collapse-item" style="color: white; font-size: 13px;"
                                    ...
                                    @if (Gate::check('manage project task stage') || Gate::check('manage bug status'))
                                        <li
                                            class=" nav-item {{ Request::segment(1) == 'bugstatus' || Request::segment(1) == 'project-task-stages' ? 'active dash-trigger' : '' }}">
                                            <a class="nav-link collapsed" href="#" data-toggle="collapse"
            ...
            @if (\Auth::user()->show_pos() == 1)
                @if (Gate::check('manage warehouse') ||
                    ...
                    <li
                        class="d-none nav-item {{ Request::segment(1) == 'warehouse' || Request::segment(1) == 'purchase' || Request::route()->getName() == 'pos.barcode' || Request::route()->getName() == 'pos.print' || Request::route()->getName() == 'pos.show' ? ' active dash-trigger' : '' }}">
                        <a class="nav-link collapsed" href="#" data-toggle="collapse"
                        ...
                        <div id="collapsenine" class="collapse" aria-labelledby="headingUtilities"
                            ...
                            <div class="  collapse-inner rounded">
                                ...
                                <ul
                                    class="{{ Request::segment(1) == 'warehouse' || Request::segment(1) == 'purchase' || Request::route()->getName() == 'pos.barcode' || Request::route()->getName() == 'pos.print' || Request::route()->getName() == 'pos.show' ? 'show' : '' }}">
                                    @can('manage warehouse')
                                        <li
                                            class=" {{ Request::route()->getName() == 'warehouse.index' || Request::route()->getName() == 'warehouse.show' ? ' active' : '' }}">
                                            <a class="collapse-item" style="color: white; font-size: 13px;"
                                    ...
                                    @can('manage purchase')
                                        <li
                                            class=" {{ Request::route()->getName() == 'purchase.index' || Request::route()->getName() == 'purchase.create' || Request::route()->getName() == 'purchase.edit' || Request::route()->getName() == 'purchase.show' ? ' active' : '' }}">
                                            <a class="collapse-item" style="color: white; font-size: 13px;"
                                    ...
                                    @can('manage pos')
                                        ...
                                        <li
                                            class=" {{ Request::route()->getName() == 'pos.report' || Request::route()->getName() == 'pos.show' ? ' active' : '' }}">
                                            <a class="collapse-item" style="color: white; font-size: 13px;"
                                    ...
                                    @can('create barcode')
                                        <li
                                            class=" {{ Request::route()->getName() == 'pos.barcode' || Request::route()->getName() == 'pos.print' ? ' active' : '' }}">
                                            <a class="collapse-item" style="color: white; font-size: 13px;"
                                    ...
                                    @can('manage pos')
                                        <li
                                            class=" {{ Request::route()->getName() == 'pos-print-setting' ? ' active' : '' }}">
                                            <a class="collapse-item" style="color: white; font-size: 13px;"
    ...
    @if (\Auth::user()->type == 'client')
        <ul
            ...
            @if (Gate::check('manage contract'))
                <li
                    class="nav-item {{ Request::route()->getName() == 'contract.index' || Request::route()->getName() == 'contract.show' ? 'active' : '' }}">
                ...
                <a class="nav-link collapsed" href="#" data-toggle="collapse"
                    ...
                    <li style=""
                        ...
                        <a class="collapse-item"   style="color:white; font-size: 13px;"
                            ...
                            <img src="{{ asset('assets/cs-theme/icons/Layer_1 (2).png') }}" width="15px" height="15px" style="margin-top:-10px" alt="" srcset="">
                    ...
                    <a class="collapse-item"   style="color:white; font-size: 13px;"
                        ...
                        <img src="{{ asset('assets/cs-theme/icons/administrator-developer-icon 1.png') }}" width="15px" height="15px" style="margin-top:-10px" alt="" srcset="">
