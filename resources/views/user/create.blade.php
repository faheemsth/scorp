    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="password" class="form-control" placeholder="Enter User Password" value="" name="password" required minlength="6">
                @else
                <input type="text" class="form-control" placeholder="Enter User Password" value="{{ $autoGeneratedPassword }}" value="" name="password" required minlength="6">
                @endif
                @error('password')
