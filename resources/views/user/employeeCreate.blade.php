{{ Form::open(['url' => route('user.employee.store'), 'method' => 'post', 'id' => 'createEmployee' ,'novalidate' => 'novalidate']) }}
                ...
                <div class="col-md-6 d-none">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Enter User Password"
                            value="study1234" name="password" required minlength="6">
                        @error('password')
...
<div class="modal-footer">
    ...
    <input type="submit" value="{{ __('Create') }}" class="btn  btn-dark px-2 py-2 create-employee">
</div>
...
<script>
    ...
    $(document).on("submit", "#createEmployee", function(event) {
        event.preventDefault(); // Prevent the default form submission
        // Serialize form data
        var formData = $(this).serialize();

         // Change button text and disable it
        $(".create-employee").text('Creating...').prop("disabled", true);
              ...
              if(data.status == 'success'){
                show_toastr('Success', data.msg, 'success');
                  ...
                  $(".block-screen").css('display', 'none');
                   // Change button text and disable it
                  $(".create-employee").text('Create').prop("disabled", false);
