                        ...
                        <div class="card text-center">
                            ...
                            <div class="card-body full-card px-1 pb-0" style="padding-top:5px">
                                <div class="img-fluid rounded-circle card-avatar">
                                    <img style="width: 60px;height: 60px;" src="{{(!empty($user->avatar))? asset(Storage::url("uploads/avatar/".$user->avatar)): asset(Storage::url("uploads/avatar/avatar.png"))}}" class="img-user wid-80 round-img rounded-circle">
                                </div>
                                ...
                                <div class="text-center" style="font-size: 10px;" data-bs-toggle="tooltip" title="{{__('Last Login')}}">
