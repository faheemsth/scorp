                ...
                <form action="/applications/" method="GET" class="">
                    <div class="row my-3">
                            <div class="col-md-4">                                              <label for="">Name</label>
                                <select class="form form-control select2" id="choices-multiple110" name="applications[]" multiple
                                    style="width: 95%;">
                                    <option value="">Select Application</option>
                                    @foreach ($app_for_filer as $app)
                                        <option value="{{ $app->name }}"
                                            <?= isset($_GET['applications']) && in_array($app->name, $_GET['applications']) ? 'selected' : '' ?>
                                            class="">{{ $app->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="col-md-4">                                              <label for="">University</label>
                                <select class="form form-control select2" id="choices-multiple111" name="universities[]" multiple
                                    style="width: 95%;">
                                    <option value="">Select University</option>
                                    @foreach ($universities as $key => $name)
                                        <option value="{{ $key }}"
                                            <?= isset($_GET['universities']) && in_array($key, $_GET['universities']) ? 'selected' : '' ?>
                                            class="">{{ $name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <select name="stages[]" id="stages" class="form form-control select2" multiple
                                    style="width: 95%;">
                                    <option value="">Select Stage</option>
                                    @foreach ($stages as $key => $stage)
                                        <option value="{{ $key }}"
                                            <?= isset($_GET['stages']) && in_array($key, $_GET['stages']) ? 'selected' : '' ?>
                                            class="">{{ $stage }}</option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="col-md-4 mt-2">
                            ...
                            <a href="/applications/" class="btn form-btn"
