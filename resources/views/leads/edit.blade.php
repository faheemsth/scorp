                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="d-flex gap-1 mb-1"
                                                        ...
                                                        <input type="text" class="form-control d-none" placeholder="Prefix" name="lead_prefix" value="{{$lead->title}}">
                                                        <input type="text" class="w-50 form-control" placeholder="First Name" name="lead_first_name" value="{{ $name[0] }}" required>
                                                        <input type="text" class="w-50 form-control" placeholder="Last Name" name="lead_last_name" value="{{ isset($name[1]) ? $name[1]
 : ''}}" required>
                                                    </td>
                                                </tr>
                                                    ...
                                                    <td class=""
                                                        ...
                                                        <select class="form-control select2" id="choice-1" name="lead_stage">
                                                            ...
                                                            @foreach($stages as $key => $stage)
                                                                <option value="{{$key}}" <?= $lead->stage_id == $key ? 'selected' : ''?>>{{$stage}}</option>
                                                            @endforeach
                                                          </select>
                                                    </td>
                                                </tr>
                                                    ...
                                                    <td class=""
                                                        ...
                                                        <select class="form-control select2" id="choice-2" name="lead_assgigned_user">
                                                           ...
                                                           @foreach($users as $key => $user)
                                                            <option value="{{$key}}" <?= $lead->user_id == $key ? 'selected' : '' ?> >{{$user}}</option>
                                                           @endforeach
                                                          </select>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class=""
                                                        style="padding-left: 10px; font-size: 13px;">
                                                        <select class="form-control select2" id="choice-4" name="lead_organization">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class=""
                                                        ...
                                                        <select class="form-control select2" id="choice-5" name="lead_source">
                                                            ...
                                                            <option value="{{$key}}" <?= $lead->sources == $key ? 'selected' : '' ?>>{{$source}}</option>
                                                            @endforeach
                                                          </select>
                                                    </td>
                                                </tr>
                                        ...
                                        <table class="w-100">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class=""
                                                        style="padding-left: 10px; font-size: 13px;">
                                                        <input type="email" class="form-control" name="lead_email" value="{{$lead->email}}" required>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr class="d-none">
                                                    ...
                                                    <td class=""
                                                        style="padding-left: 10px; font-size: 13px;">
                                                        <input type="email" class="form-control" name="referrer_email" value="{{$lead->referrer_email}}">
                                                    </td>
                                                </tr>
                                                ...
                                                <tr class="d-none">
                                                    ...
                                                    <td class=""
                                                        style="padding-left: 10px; font-size: 13px;">
                                                        <input type="text" class="form-control" name="lead_mobile_phone" value="{{ $lead->mobile_phone }}">
                                                    ...
                                                    <td class=""
                                                        ...
                                                        <div class="row">
                                                            <div class="col-6 col-form">
                                                                <input type="text" class="form-control" id="formGroupExampleInput" placeholder="City" name="lead_city" value="{{ $lead->city }}">
                                                            </div>
                                                            <div class="col-6 col-form">
                                                                <input type="text" class="form-control" id="formGroupExampleInput" placeholder="State/Province" name="lead_state" value="{{ $lead->state }}">
                                                            </div>
                                                            <div class="col-6 col-form">
                                                                <input type="text" class="form-control" id="formGroupExampleInput" placeholder="Postel Code" name="lead_postal_code" value="{{ $lead->postal_code }}">
                                                            </div>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="" style="padding-left: 10px;">
                                                        <select name="lead_tags_list" id="choice-7" class="form form-control select2">
                                                            <option value=""></option>
                                                            if($lead->tags)
                                                            <option selected value="{{$lead->tags}}">{{$lead->tags}}</option>
