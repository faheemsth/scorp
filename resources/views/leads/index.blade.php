...
@section('action-btn')
    <div class="float-end">
        ...
        {{ Form::select('default_pipeline_id', $pipelines, $pipeline->id, ['class' => 'form-control select', 'id' => 'default_pipeline_id', 'style' => '200px']) }}
        {{ Form::close() }}
...
<div class="row align-items-center">
    ...
    <div class="col-10 d-flex justify-content-end gap-2">
        ...
        <div class="dropdown">
            <button class="btn btn-primary dropdown-toggle px-2 pb-1 pt-2" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
            ...
            <button class="btn btn-primary px-2 py-1" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
              New Lead
            </button>
    </div>
    </div>
