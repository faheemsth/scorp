...
<div class="modal-body">
    <div class="row">
        ...
        <div class="col-6 form-group">
            ...
            {{ Form::select('stage_id', [''=>__('Select Stage')],null, array('class' => 'form-control select','required'=>'required','style'=>'height:40px;')) }}
        </div>
        <div class="col-6 form-group">
        ...
        <div class="col-12 form-group">
           <div class="row w-100">
            ...
            <div class="col-12">
                {{ Form::textarea('notes',null, array('class'=>'summernote-simple w-100')) }}
            </div>
           </div>
        </div>
    </div>
