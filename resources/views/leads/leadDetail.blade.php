                        ...
                        <div class="tab-content" id="pills-tabContent">
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="panelsStayOpen-collapseinfo" class="accordion-collapse collapse show" aria-labelledby="panelsStayOpen-headinginfo">
                                                    ...
                                                    <table>
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="padding-left: 10px; font-size: 14px;">
                                                                    <div class="bg-danger text-white">
                                                                        <p class="mb-0" style="padding-left: 10px; font-size: 14px;">
                                                                            {{ $lead->stage->name }}
                                                                        </p>
                                                                    </div>
                                                                </td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="organization_id-td" style="padding-left: 10px; font-size: 14px;" class="edit-td">
                                            ...
                                            <tr>
                                                ...
                                                <td class="sources-td" style="padding-left: 10px; font-size: 14px;">
                                                    ...
                                                    <div class="d-flex edit-input-field-div">
                                                        ...
                                                        <div class="edit-btn-div">
                                                            <button class="btn btn-secondary rounded-0 btn-effect-none edit-input" name="sources"><i class="ti ti-pencil"></i></button>
                                                        </div>
                                                    </div>
                                            ...
                                            <tr>
                                                <td class="" style="width: 194px; text-align: right; font-size: 14px;">
                                                    {{ __('Link Email Address') }}
                                                </td>
                                                <td class="d-flex align-items-center" style="padding-left: 10px; font-size: 14px;">
                                            ...
                                            <tr>
                                                ...
                                                <td class="drive_link-td" style="padding-left: 10px; font-size: 14px; width:300px">
                                                    ...
                                                    <div class="d-flex edit-input-field-div">
                                                        ...
                                                        <div class="edit-btn-div">
                                                            <button class="btn btn-secondary rounded-0 btn-effect-none edit-input" name="drive_link"><i class="ti ti-pencil"></i></button>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="table-responsive mt-1" style="margin-left: 10px;">
                                            ...
                                            <table>
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td class="email-td" style="padding-left: 10px; font-size: 14px;">
                                                            <div class="d-flex align-items-baseline edit-input-field-div">
                                                                ...
                                                                <div class="edit-btn-div">
                                                                    <button class="btn btn-secondary rounded-0 btn-effect-none edit-input" name="email" style="padding: 10px;"><i class="ti ti-pencil"></i></button>
                                                                </div>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td class="" style="width: 200px; text-align: right; font-size: 14px;">
                                                            {{ __('Email Address (Referrer)') }}
                                                            <i class="ti ti-help"></i>
                                                        </td>
                                                        <td class="referrer_email-td" style="padding-left: 10px; font-size: 14px;">
                                                            <div class="d-flex edit-input-field-div">
                                                                <div class="input-group border-0 referrer_email">
                                                                    {{ $lead->referrer_email }}
                                                                </div>
                                                                <div class="edit-btn-div">
                                                                    <button class="btn btn-sm btn-secondary rounded-0 btn-effect-none edit-input" name="referrer_email" style="padding: 10px;"><i class="ti ti-pencil"></i></button>
                                                                </div>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="mobile_phone-td" style="padding-left: 10px; font-size: 14px;width:300px">
                                                            ...
                                                            <div class="d-flex edit-input-field-div">
                                                                ...
                                                                <div class="edit-btn-div">
                                                                    <button class="btn btn-secondary rounded-0 btn-effect-none edit-input" name="mobile_phone"><i class="ti ti-pencil"></i></button>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="phone-td" style="padding-left: 10px; font-size: 14px;">
                                                            ...
                                                            <div class="d-flex edit-input-field-div">
                                                                ...
                                                                <div class="edit-btn-div">
                                                                    <button class="btn btn-secondary rounded-0 btn-effect-none edit-input" name="phone" style="padding: 10px;"><i class="ti ti-pencil"></i></button>
                                                                </div>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td class="" style="width: 130px; text-align: right; font-size: 14px;">
                                                            {{ __('Email Opted Out') }}
                                                        </td>
                                                        <td class="" style="padding-left: 10px; font-size: 14px;">
                                                            ...
                                                            <div class="d-flex align-items-baseline edit-input-field-div">
                                                                ...
                                                                <button class="btn btn-sm btn-secondary edit-btn-data rounded-0 btn-effect-none" style="padding: 3px 6px;"><i class="ti ti-pencil"></i>
                                                                </button>
                                    ...
                                    <div class="accordion-body">
                                        <div class="table-responsive mt-1" style="margin-left: 10px;">
                                            ...
                                            <table>
                                                <tbody>
                                                    <tr>
                                                        <td class="" style="width: 190PX; text-align: right; font-size: 14px;">
                                                            {{ __('Address') }}
                                                        </td>
                                                        <td class="address-td" style="min-width: 250PX; text-align: right; font-size: 13px;padding-left:10px;">
                                                            <div class="d-flex edit-input-field-div">
                                    ...
                                    <div class="accordion-body">
                                        <div class="table-responsive mt-1" style="margin-left: 10px;">
                                            <table>
                                                <tbody>
                                                    <tr>
                                                        <td class="" style="width: 196px; text-align: right; font-size: 14px;">
                                                            {{ __('Description') }}
                                                        </td>
                                                        <td class="" style="width:550px; padding-left:15px; text-align: justify; font-size: 14px;">
                                                            {{ $lead->keynotes }}
                                                        </td>
                                                    </tr>
                                                </tbody>
                                    ...
                                    <div class="accordion-body">
                                        <div class="table-responsive mt-1" style="margin-left: 10px;">
                                            ...
                                            <table>
                                                <tbody>
                                                    <tr>
                                                        <td class="" style="width:200px;font-size: 14px;text-align:right;">
                                                            {{ __('Tag List') }}
                                                        </td>
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="panelsStayOpen-headingkeydetails">
                                    <button class="accordion-button p-2" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapsekeydetails">
                                        {{ __('LEAD CONVERSION DETAILS') }}
                                    </button>
                                </h2>
                                <div id="panelsStayOpen-collapsekeydetails" class="accordion-collapse collapse show" aria-labelledby="panelsStayOpen-headingkeydetails">
                                    <div class="accordion-body">
                                        <div class="table-responsive mt-1" style="margin-left: 10px;">
                                                            ...
                                                            <div class="card">
                                                                ...
                                                                <div class="card-body px-0">
                                                                    <ul class="list-group list-group-flush mt-2">
                                                                        ...
                                                                        <li class="list-group-item px-0" style="list-style: none;">
                                                                            <div class="d-block d-sm-flex align-items-start">
                                                                                <img src="@if ($discussion->user->avatar) {{ asset('/storage/uploads/avatar/' . $discussion->user->avatar) }} @else {{ asset('/storage/uploads/avatar/avatar.png') }} @endif" class="img-fluid wid-40 me-3 mb-2 mb-sm-0" alt="image">
                                                                                <div class="w-100">
