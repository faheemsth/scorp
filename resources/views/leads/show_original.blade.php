                            ...
                            <div class="card">
                                ...
                                <div class="card-header">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <h5>{{__('Courses')}}</h5>
                                        <div class="float-end">
                                            <a data-size="md" data-url="{{ route('leads.courses.edit',$lead->id) }}" data-ajax-popup="true" data-bs-toggle="tooltip" title="{{__('Add Course')}}" class="btn btn-sm btn-primary">
                                                <i class="ti ti-plus"></i>
                                            </a>
                                        </div>
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <input type="text" class="form form-control lead-drive-link" placeholder="Drive Link" value="{{$deal->drive_link}}">
                                        <input type="hidden" class="lead-drive-url" value="{{$lead->id}}/drive-link">
