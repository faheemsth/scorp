                    ...
                    <div class="card-body table-border-style" style="padding: 25px 3px;">
                        ...
                        <div class="row align-items-center ps-0 ms-0 pe-4 my-2">
                            ...
                            <div class="col-8 d-flex justify-content-end gap-2">
                                ...
                                @can('create lead')
                                    <button data-size="lg" data-url="{{ route('leads.create') }}" data-ajax-popup="true"
                                        data-bs-toggle="tooltip" title="{{ __('Create New Lead') }}" class="btn px-2 btn-dark">
