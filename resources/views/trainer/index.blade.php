                ...
                <div class="card-body table-border-style">
                    <div class="row align-items-center ps-0 ms-0 pe-4 my-2">
                        ...
                        <div class="col-8 d-flex justify-content-end gap-2 pe-0">
                            ...
                            @can('create trainer')
                                <a href="#" data-size="lg" data-url="{{ route('trainer.create') }}"
                                    data-ajax-popup="true" data-bs-toggle="tooltip" title="{{ __('Create New Trainer') }}"
                                    data-title="{{ __('Create New Trainer') }}" class="btn px-2 btn-dark"
                                    style="color:white; width:36px; height: 36px; margin-top:10px;">
                                    ...
                                    <tr>
                                        <td>
                                            <span style="cursor:pointer" class="lead-name hyper-link"
                                                onclick="openSidebar('/show-trainer?id=<?= $trainer->id ?>')"
                                                data-lead-id="{{ $trainer->id }}">{{ $trainer->firstname . ' ' . $trainer->lastname }}</span>
                                        </td>
                                        <td>{{ $trainer->brand }}</td>
