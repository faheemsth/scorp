            ...
            <div class="lead-topbar d-flex flex-wrape justify-content-between align-items-center p-2">
                <div class="d-flex align-items-center">
                    ...
                    <div class="lead-basic-info">
                        <p class="pb-0 mb-0 fw-normal">{{ __('Trainer') }}</p>
                        <div class="d-flex align-items-baseline">
                            <h5 class="fw-bold">{{ $trainers->name }}</h5>
                        </div>
                    </div>
                ...
                <div class="d-flex justify-content-end gap-1 me-3">
                    @can('edit trainer')
                    <a href="#!" data-size="lg" data-url="{{ route('trainer.edit', $trainers->id) }}" data-ajax-popup="true" class="btn px-2 py-2 btn-dark  text-white" style="margin: auto" data-bs-original-title="{{__('Edit Trainer')}}" data-bs-toggle="tooltip" title="{{ __('Edit Trainer') }}">
                    ...
                    <a href="#!" class="btn px-2 py-2 btn-danger mt-3 text-white bs-pass-para " data-bs-toggle="tooltip" title="{{ __('Delete') }}" data-confirm="{{ __('Are You Sure?') . '|' . __('This action can not be undone. Do you want to continue?') }}"
                    data-confirm-yes="document.getElementById('delete-form-{{ $trainers->id }}').submit();"
                                                    ...
                                                    <table>
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="" style="padding-left: 10px; font-size: 14px;">
                                                                   <a href="{{ $trainers->email }}" target="_blank" >{{ $trainers->email }}</a>
                                                                </td>
                                                            </tr>
