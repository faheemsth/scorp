<div class="filter-data px-3" id="filter-show"  <?= (isset($_GET) && !empty($_GET) && empty($_GET['perPage'])) ? '' : 'style="display: none;"' ?>>
    <form action="/setsalary" method="GET" class="">
        ...
        <div class="row my-3 align-items-end">
            ...
            <div class="col-md-5 mt-3 d-flex">
                ...
                <a href="/setsalary" style="margin: 0px 3px;" class="btn form-btn bg-dark" style="color:white;">Reset</a>
                <a type="button" id="save-filter-btn" onClick="saveFilter('SalaryEmployee',<?= isset($employees) && is_countable($employees) ? sizeof($employees) : 0 ?>)" class="btn form-btn me-2 bg-dark" style=" color:white;display:none;">Save Filter</a>
            </div>
        </div>
    </form>
</div>
