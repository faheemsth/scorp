                    ...
                    <div class="card sticky-top" style="top:30px">
                        <div class="list-group list-group-flush" id="useradd-sidenav">
                            ...
                            <a href="#storage-settings" class="list-group-item list-group-item-action border-0">{{ __('Storage Settings') }}
                                <div class="float-end"><i class="ti ti-chevron-right"></i></div></a>
                            <a href="#deal-stage-settings" class="list-group-item list-group-item-action border-0">Deal Stage
                                <div class="float-end"><i class="ti ti-chevron-right"></i></div></a>
...
{{--                                                                            </label>--}}
                    ...
                    <!-- Storage Settings -->
                    <div id="deal-stage-settings" class="card mb-3">
                        {{ Form::open(array('route' => 'deal.setting.store', 'method' => 'POST', 'enctype' => "multipart/form-data")) }}
                        <div class="card-header">
                            <div class="row">
                                <div class="col-lg-10 col-md-10 col-sm-10">
                                    <h5 class="">Deal Stage</h5>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="d-flex">
                                    <div class="form-group">
                                        <label for="google_recaptcha_key" class="form-label">Deal Stage</label>
                                        <select name="deal_stage" class="form-control select" style="width: 200px;">
                                            @foreach ($stages as $key => $stage)
                                                <option <?= (isset($deal_stage->value) && $deal_stage->value == $key ) ? 'selected' : '' ?> value="{{ $key }}">
                                                    {{ $stage }}</option>
                                            @endforeach
                                        </select>
                                    </div>
