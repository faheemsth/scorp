                    ...
                    @if (
                        ...
                        <select class="form-control select2 brand_id" id="choices-1011" name="brand_id"
                            ...
                            @foreach ($companies as $key => $company)
                                <option value="{{ $key }}" {{ $key == $training->brand_id ? 'selected' : '' }}>
                                    {{ $company }}</option>
                            @endforeach
                        </select>
            ...
            <div class="form-group">
                ...
                <div id="region_div">
                    @if (
                        ...
                        {!! Form::select('region_id', $regions, $training->region_id, [
                            'class' => 'form-control select2',
                            'id' => 'region_id',
                        ]) !!}
                    @else
                        <input type="hidden" name="region_id" value="{{ $training->region_id }}">
                        {!! Form::select('region_id', $regions, $training->region_id, [
                            'class' => 'form-control select2',
                            'disabled' => 'disabled',
                            'id' => 'region_id',
                    ...
                    @if (
                        ...
                        <select name="lead_branch" id="branch_id" class="form-control select2 branch_id"
                            ...
                            @foreach ($branches as $key => $branch)
                                <option value="{{ $key }}"
                                    {{ $training->branch_id == $key ? 'selected' : '' }}>
                                    {{ $branch }}</option>
                            @endforeach
                        </select>
                    @else
            ...
            <div class="form-group">
                ...
                <div id="assign_to_divs">
                    <select class="form-control select2" id="choice-222" name="lead_assigned_user">
                        ...
                        <option value="{{$key}}"{{ $key == $training->employee ? 'selected':'' }}>{{ $employee }}</option>
                        @endforeach
                    </select>
                </div>
            </div>
