                ...
                <div class="card-body table-border-style">
                    <div class="row align-items-center ps-0 ms-0 pe-4 my-2">
                        ...
                        <div class="col-8 d-flex justify-content-end gap-2 pe-0">
                            ...
                            @can('create training')
                                <a href="#" data-size="lg" data-url="{{ route('training.create') }}"
                                    style="color:white; width:36px; height: 36px; margin-top:10px;" data-ajax-popup="true"
                                    data-bs-toggle="tooltip" title="{{ __('Create New Training') }}"
                                    data-title="{{ __('Create New Training') }}" class="btn px-2 btn-dark">
