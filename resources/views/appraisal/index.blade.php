                    ...
                    <div class="col-8 d-flex justify-content-end gap-2 pe-0 mb-3">
                        ...
                        <button id="filter-btn-show" class="btn filter-btn-show p-2 btn-dark" type="button"
                         ...
                         @can('create appraisal')
                            <a href="#" data-size="lg" data-url="{{ route('appraisal.create') }}"
                                ...
                                <tr>
                                    <td>
                                        <span style="cursor:pointer" class="lead-name hyper-link"
                                                         onclick="openSidebar('/appraisalShow?id=<?= $appraisal->id ?>')"
                                                        data-lead-id="{{ $appraisal->id }}">{{ !empty($appraisal->employees)?$appraisal->employees->name:''  }}</span>
