                        ...
                        <div id="panelsStayOpen-collapseOne" class="accordion-collapse collapse show" aria-labelledby="panelsStayOpen-headingOne">
                            <div class="accordion-body">
                                ...
                                <div class="form-group row ">
                                    <label for="organization-name" class="col-sm-3 col-form-label"> Name <span class="text-danger">*</span></label>
                                    <div class="col-sm-6">
                                ...
                                <div class="form-group row ">
                                    <label for="type-of-organization" class="col-sm-3 col-form-label">Type <span class="text-danger">*</span></label>
                                    <div class="col-sm-6">
                                        <select name="organization_type" class="form form-control select2" id="organization_type_id">
