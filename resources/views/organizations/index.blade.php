                ...
                <div class="card-body">
                    ...
                    <div class="row align-items-center ps-0 ms-0 pe-4 my-2">
                        <div class="col-2">
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                    <li><a class="dropdown-item delete-bulk-organizations"
                        ...
                        <div class="col-10 d-flex justify-content-end gap-2">
                            ...
                            <button class="btn px-2 pb-2 pt-2 refresh-list bg-dark" style=" color:white;"><i
                ...
                <div class="filter-data px-3" id="filter-show" <?= isset($_GET) && !empty($_GET) ? '' : 'style="display: none;"' ?>>
                    <form action="/organization/" method="GET" class="">
                        <div class="row my-3">
                                ...
                                <div class="col-md-4"> <label for="">County</label>
                                    <select name="country[]" id="choices-multiple333" class="form form-control select2"
                    ...
                    <div class=" mt-3">
                        <table class="table">
                            ...
                            <tbody class="organization_tbody" style="color:rgb(0, 0, 0); font-size: 14px;"
                                ...
                                @forelse($organizations as $org)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span style="cursor:pointer" class="org-name hyper-link"
                                                onclick="openNav(<?= $org->id ?>)"
