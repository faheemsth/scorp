                        ...
                        <div class="col-8 d-flex justify-content-end gap-2 pe-0 mb-3">
                            ...
                            @can('create job')
                                <a href="{{ route('job.create') }}"
                                     title="{{__('Create')}}" style="color:white; width:36px; height: 36px; margin-top:10px;"
                        ...
                        <div class="card-body table-responsive mt-1" style="padding: 25px 3px; width:auto;">
                            <table class="table " data-resizable-columns-id="lead-table" id="tfont">
                                ...
                                <tbody class="font-style">
                                    @foreach ($jobs as $job)
                                        <tr>
                                            <td style="cursor:pointer" class="lead-name hyper-link"
                                                @can('show job') onclick="openSidebar('/job/<?= $job->id ?>')" @endcan>
                                                {{ $job->title }}
                                            </td>
