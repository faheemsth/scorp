                    ...
                    <form action="/company-permission" method="GET" class="sticktopser" id="role_form">
                        <div class="row align-items-center ps-0 ms-0 pe-4 my-2 ">
                            ...
                            <div class="col-9 d-flex justify-content-end gap-2">
                                ...
                                <a class="btn d-none papu" style="background-color: #313949; color:white;"  title="{{ __('Submit') }}"
                                id="actions_div">Submit</a>
                            </div>
                        </div>
                    </form>
                                ...
                                @foreach ($employees as $emp)
                                    <tr scope="row">
                                        ...
                                        @foreach ($companies as $comp)
                                            ...
                                            <td>
                                                <input type="checkbox" class="company-permission-checkbox sub-check"
