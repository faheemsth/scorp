...
@endsection
@section('content')
{{Form::open(array('class'=>'mainlogindiv','route'=>'admin-login','method'=>'post','id'=>'loginForm' ))}}
@csrf
<div class="border  border-3  p-4" style="border-radius : 25px ; background: linear-gradient(to bottom right,rgb(122 122 122 / 24%),#cac9c987,rgb(71 71 71)); ">
    ...
    <div class="text-center">
        ...
        <button type="submit" id="login_button" class=" w-50 p-2  mt-3 " style="background-color: #000000; color:#FFFFFF ;">LOGIN</button>
    </div>
