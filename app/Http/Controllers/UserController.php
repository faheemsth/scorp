...
class UserController extends Controller
{
    ...
    public function create()
    {
        ...
        if (\Auth::user()->can('create user')) {
            ...
            return view('user.create', compact('roles', 'customFields', 'branches', 'autoGeneratedPassword'));
        } else {
            return redirect()->back();
        }
    }
    ...
    public function employeeCreate()
    {
        ...
        if (\Auth::user()->can('create user')) {
            ...
            return view('user.employeeCreate', compact('roles', 'customFields', 'branches', 'autoGeneratedPassword', 'companies'));
        } else {
            return redirect()->back();
        }
    }
    ...
    public function emplpoyeeUpdate(Request $request, $id)
    {
