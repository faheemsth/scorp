...
class ContractController extends Controller
{
    ...
    {
        if(\Auth::user()->can('manage contract') || \Auth::user()->type=='super admin')
        {
            ...
            elseif(\Auth::user()->type=='client')
            {
                ...
                return view('contract.index', compact('contracts', 'users'));
            }
    ...
    {
        if(\Auth::user()->can('show contract') || \Auth::user()->type =='super admin')
        {
            $contract =Contract::find($id);
           
            if($contract->created_by == \Auth::user()->creatorId() || \Auth::user()->type =='super admin')
            {
